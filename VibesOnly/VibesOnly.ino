...
void processInstruction(String instruction) {
  ...
  */
  ...
  if (value1 == "O") {
    AudioOn = true;  //audio.connecttoFS(SPIFFS, "StartUp.mp3");
    delay(500);
  }
  ...
  else if (value1 == "G") { //General Race Info
    generalInfo = true;
    AudioOn = true;
  }
