...
void moveToGoalAndBack()
{
    moveStepToPosWithSpeed(0, 30, 3000, 3000);
    vTaskDelay(1);

    moveStepToPosWithSpeed(50, 30, 10000, 10000);
    vTaskDelay(1);
}
...
void moveStepToPosWithSpeed(long x, long y, long _xSpd, long _ySpd)
{
...
void homeSteppers()
{
    ...
    // Move the steppers to the center of the pitch initially 
    moveStepsToPos(50, 30);
}
